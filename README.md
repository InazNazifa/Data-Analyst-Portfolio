...
- **Technology**: Python, Pandas, NumPy, Matplotlib, Seaborn, Scikit-learn.
- **Results**:
1. Subscription Rate for Control Group (Telephone): 14.62%
2. Subscription Rate for Variant Group (Cellular): 14.36%
3. Chi-square Statistic: 87.86985650165812, P-Value: 8.30430129641147e-20
